...
def _parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--causal", default=True, action=argparse.BooleanOptionalAction, help="Whether to use causal masking")
    ...
    parser.add_argument("--pooling_strategy", default=None, type=str, choices=["first", "last", "mean", "max"], help="Pooling strategy to use. If None, will be automatically determined based on model type.")
